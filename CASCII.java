...
// CASCII.java// A simplified version of ASCII for encryption and decryption needs
 ...
 * @author Michael May * @version 1.0
 */
...
public static char Convert( byte[] bits, int start, int end)  {
    ...
    if ( end - start != 4 )    {
        throw new java.lang.IllegalArgumentException("Argument must only be five bitslong");
    }
...
public static byte[] Convert( String s )  {
    ...
    int size = 5 * s.length();    // pad it to be a multiple of 8
    size = size + ( 8 - (size % 8) );
